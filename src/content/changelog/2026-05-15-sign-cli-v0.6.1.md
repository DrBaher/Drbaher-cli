...
Install: `npm i -g @drbaher/sign-cli` (now published under the scoped name on npm — the unscoped `sign-cli` belongs to a different project that has nothing to do with this one).
