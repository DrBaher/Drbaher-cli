/**
 * Auto-link references to the seven CLIs in markdown content.
...
const CLIS = ['template-vault-cli', 'nda-review-cli', 'docx2pdf-cli', 'compare-cli', 'extract-cli', 'draft-cli', 'sign-cli'];
